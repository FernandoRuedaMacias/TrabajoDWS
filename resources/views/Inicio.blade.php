...
<table style="width: 100%">
    <tr><td>
        <div >
            <img src="{{ URL::to('/images/foto1.avif') }} "  style="width:100%"  width="500" height="500">
        </div>
    </td>
    <td>
        <div >
            <img src="{{ URL::to('/images/foto2.avif') }} " style="width:100%"  width="500" height="500">
        </div>
    </td>
        </tr>
        ...
        <a href="{{route('indicePlatos')}}" class="btn btn-dark">PLATOS</a>
      </div>
</body>
</html>